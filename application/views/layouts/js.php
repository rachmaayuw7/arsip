  ...
  <script src="<?= base_url('skydash'); ?>/vendors/typeahead.js/typeahead.bundle.min.js"></script>
  <script src="<?= base_url('skydash'); ?>/vendors/select2/select2.min.js"></script>
  ...
  <script src="<?= base_url('skydash'); ?>/js/file-upload.js"></script>
