<div class="row">
    <div class="col-md-6 col-sm-12">
        <a onclick="window.location.href='<?= base_url()?>/Kategori'" style = "color: black;cursor:pointer;"><h1 style="display: inline;" href>Kategori</h1></a><h2 style="display: inline;"> >> Tambah</h2>
            ...
            <div class="card-body">
                <form action = "#" class="forms-sample">
                    <div class="form-group">
                        ...
                        <input type="text" name = "id_ktg" class="form-control" id="id_ktg" placeholder="ID kategori" value = "<?= $id ?>" disabled require/>
                    </div>
                    <div class="form-group">
                        <label for="nama_kategori">Nama Kategori</label>
                        <input type="text" class="form-control" id="nama_kategori" name ="nama_kategori" placeholder="Nama Kategori" require/>
                    </div>
                    <div class="form-group">
                        <label for="keterangan">Keterangan</label>
                        <input type="text" class="form-control" id="keterangan" name ="keterangan" placeholder="Keterangan" require/>
                    </div>
...
<script>
    function simpan(){
        ...
        $.ajax({
            url:`<?= base_url(); ?>Kategori/simpanKtg`,
            type:'POST',
            data: form,
            contentType: false,
            processData: false,
